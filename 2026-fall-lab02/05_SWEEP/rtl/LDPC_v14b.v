...
//=============================================================
// round_half_up(0.75 * m), m = y + s: mag = 3 * key[5:3] + t, t = f(key[2:0]) in 0~3
// (the two dropped fraction bits only produce t, the carry chain is 5 bits)
module LDPC_NORM (
    input [5:0] key,
    output [4:0] mag
);
    ...
    always @(*) begin : NORM_T
        case(key[2:0])
            3'd0: t = 2'd0; 3'd1: t = 2'd1; 3'd2: t = 2'd1; 3'd3: t = 2'd2;
            3'd4: t = 2'd2; 3'd5: t = 2'd2; 3'd6: t = 2'd2; default: t = 2'd3;
        endcase
    end

    assign mag = {1'b0, key[5:3], 1'b0} + {2'b00, key[5:3]} + {3'b000, t};
