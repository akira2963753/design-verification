...
module LDPC_MIN7 (
    ...
    // c_y = (m2_a < m1_b) <=> at least 2 A keys below m1_b; m1_b settles before m2_a
    assign lb = {(key[23:18] < m1_b), (key[17:12] < m1_b), (key[11:6] < m1_b), (key[5:0] < m1_b)};
    assign c_y = (lb[0] && lb[1]) || (lb[2] && lb[3]) || ((lb[0] || lb[1]) && (lb[2] || lb[3]));
