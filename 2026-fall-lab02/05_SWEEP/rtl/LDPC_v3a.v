...
//=============================================================
//      7-input min1 / min2 / idx finder (11 comparators)
//=============================================================
// Same function as the v2 tree (lowest port wins ties); every merge compares its
// two min2 candidates in parallel with the min1 comparison.
module LDPC_MIN7 (
    input [41:0] key,
    output [5:0] min1,
    output [5:0] min2,
...
//=============================================================
// Inputs (a1 <= a2), (b1 <= b2); 3 comparators in parallel
module LDPC_MERGE #(
    parameter W = 6,
    parameter IW = 1
) (
    ...
    assign c = (b1 < a1);
    assign x = (b2 < a1)? b2 : a1;
    assign y = (a2 < b1)? a2 : b1;
    assign m1 = (c)? b1 : a1;
    assign m2 = (c)? x : y;
