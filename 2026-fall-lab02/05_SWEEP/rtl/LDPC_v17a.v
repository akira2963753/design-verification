...
module LDPC_MIN7 (
    ...
    // a < b for 6b unsigned keys: per-bit less / equal, 3-bit group lookahead, then merge
    function lt6;
        input [5:0] a;
        input [5:0] b;
        reg [5:0] g, e;
        ...
        begin
            g = ~a & b;
            e = ~(a ^ b);
            g_hi = g[5] | (e[5] & g[4]) | (e[5] & e[4] & g[3]);
            e_hi = e[5] & e[4] & e[3];
            g_lo = g[2] | (e[2] & g[1]) | (e[2] & e[1] & g[0]);
            lt6 = g_hi | (e_hi & g_lo);
        end
    endfunction

    // Final merge: both min2 candidates are compared in parallel with c_f
    assign c_f = lt6(m1_b, m1_a);
    assign c_x = lt6(m2_b, m1_a);
    assign c_y = lt6(m2_a, m1_b);
...
module LDPC_MIN4 (
    ...
    assign w01 = lt6(k1, k0);
    assign w02 = lt6(k2, k0);
    assign w03 = lt6(k3, k0);
    assign w12 = lt6(k2, k1);
    assign w13 = lt6(k3, k1);
    assign w23 = lt6(k3, k2);
